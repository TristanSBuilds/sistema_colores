...
class Color{
    ...
    crearColor(contenedor){
        ...
        botonEditar.addEventListener("click", () => {
            // para el rgb no creamos una copia del array de arriba, solo una direccion(puntero) hacia el color en cuestión
            colorEditar = this
        ...
        botonBorrar.addEventListener("click", () => {
            // sacamos el id para poder encontrarlo al eliminar color
            colorBorrar = this
...
function color({id,r,g,b}){
    // creamos el espacio en memoria UNICO para el color del li especifo
    let rgb = [r,g,b]
    ...
    const botonEditar = li.querySelector(".btn-editar")
    const botonBorrar = li.querySelector(".btn-borrar")

    botonBorrar.addEventListener("click", () => {
        // sacamos el id para poder encontrarlo al eliminar color
        colorBorrar = { id : id, item : li}
        modalBorrar.classList.add("modal-visible")
    })

    botonEditar.addEventListener("click", () => {
        // para el rgb no creamos una copia del array de arriba, solo una direccion(puntero) hacia el color en cuestión
        colorEditar = { id : id, item : li, rgb }
